...
:root {
  ...
  --primary-glow: oklch(0.68 0.14 235);
  ...
  --accent-foreground: oklch(0.28 0.1 245);
  --gold: oklch(0.78 0.13 82);
  --destructive: oklch(0.6 0.22 27);
  --destructive-foreground: oklch(1 0 0);
  --border: oklch(0.92 0.012 240);
  --input: oklch(0.94 0.012 240);
  --ring: oklch(0.6 0.15 245);
  --gradient-hero: linear-gradient(135deg, oklch(0.55 0.16 245) 0%, oklch(0.68 0.14 235) 100%);
  --gradient-soft: linear-gradient(180deg, oklch(0.98 0.012 240) 0%, oklch(0.995 0.003 240) 100%);
  --shadow-elegant: 0 10px 40px -10px oklch(0.55 0.16 245 / 0.25);
  --shadow-card: 0 2px 12px -4px oklch(0.55 0.16 245 / 0.12);
